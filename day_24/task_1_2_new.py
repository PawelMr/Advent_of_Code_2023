...
def find_intersection_xy(point_a, point_b):
    ...
    if vy_b / vx_b == vy_a / vx_a:
        return False

    b1 = y_a - vy_a / vx_a * x_a
    b2 = y_b - vy_b / vx_b * x_b

    x = int((y_b - vy_b / vx_b * x_b - y_a + vy_a / vx_a * x_a) / (vy_a / vx_a - vy_b / vx_b))
    y = int(vy_a / vx_a * x + y_a - vy_a / vx_a * x_a)
...
point_xy = select_coordinates_xy(start_map[:16], speed_range=(-80, 300))
print(point_xy)
